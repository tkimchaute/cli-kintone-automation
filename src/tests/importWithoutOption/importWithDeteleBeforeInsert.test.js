...
describe('Import without --import option: Delete all records before inserting (-D=true)', () => {
    ...
    test('C261: Verify that all records will be deleted before inserting', async () => {
    ...
    test('C261: Guest space - Verify that all records will be deleted before inserting', async () => {
    ...
    test('C262: Verify that all records will be deleted before inserting with attachment file directory (-f -b -D)', async () => {
        // Import data in the first time
    ...
    test('C263: Verify that no record will be deleted when not specifying -D', async () => {
        // Import data in the first time
        const importTest1 = new ImportTestCommon(appInfo, userCreds, importedCSVFile);
        const result1 = await importTest1.importWithUserNamePassword();

        // Import data in the second time
        const importTest2 = new ImportTestCommon(appInfo, userCreds, importedCSVFile, false);
        const result2 = await importTest2.importWithUserNamePassword();
    ...
    test('C265: Verify that all records will be deleted before inserting using API Token', async () => {
        // Import data in the first time
        const importTest1 = new ImportTestCommon(appInfo, userCreds, importedCSVFile);
