...
describe('Import with --import option: Update current data with file by using * in front of field code (-f)', () => {
    ...
    test('C061: Verify that data will be updated correctly, the revision is increased by 1 after update', async () => {
        // C062, C081, C089 will be test at C061
        const updateTest = new ImportTestCommon(appInfo, adminUser, updateDataByNumberField);
    ...
    test('C063: Verify that data will be updated when using * for multiple fields (e.g. *Text, *Number)', async () => {
        const updateTest = new ImportTestCommon(appInfo, adminUser, updateDataByMultiField);
        const result = await updateTest.importWithUserNamePassword();
    ...
    test('C090: Verify the updated record is added as new record when leaving the value of *field is blank', async () => {
    ...
    test('C097: Verify that data will be updated correctly using API Token', async () => {
        const updateTest = new ImportTestCommon(appInfo, adminUser, updateDataByNumberField);
