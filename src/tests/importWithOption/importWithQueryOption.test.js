...
describe('Delete selected records (by -q param) before inserting', () => {
    ...
    test('C107: Verify that records will be deleted according to the query before inserting', async () => {
    ...
    test('C107: Guest space - Verify that records will be deleted according to the query before inserting', async () => {
