...
describe('Export with --export option: Export data with field (-c)', () => {
    ...
    test('Case 172: Guest space - Verify that only data of fields listed in -c parameter are returned', async () => {
    ...
    test('Case 175: In the combination with -e, Verify that only data of fields listed in -c parameter are returned', async () => {
        const fieldArg = `-c ${fieldNames}`;
    ...
    test('Case 176: In the combination with -e -q, Verify that only data of fields listed in -c parameter are returned', async () => {
        const fieldArg = `-c ${fieldNames}`;
        const encodingArg = '-e utf-8';
    ...
    test('Case 177: In the combination with -e -q -g, in which value of -g is 0, Verify that only data of fields listed in -c parameter are returned', async () => {
        const fieldArg = `-c ${fieldNames}`;
        const encodingArg = '-e utf-8';
        const queryArg = '-q "Number>1002"';
